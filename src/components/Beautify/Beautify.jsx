...
export default function Beautify() {
    ...
    return <>
        <div className={`flex justify-evenly items-center py-16 bg-[#F2F5FF] transition-transform duration-500 wow animate__flipInX`} >
            <div className="flex flex-col justify-center items-start w-1/4 wow animate__jackInTheBox">
